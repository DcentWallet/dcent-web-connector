...
function __decoyBanner () {
  var banner = document.createElement('div')
  banner.style.cssText = 'display:none;background:var(--pg-raised);color:var(--pg-fg);border:1px solid var(--pg-border);'
  return banner
}
...
function bannerMake () {
  var banner = document.createElement('div')
  banner.style.cssText = 'display:none;background:var(--pg-fg);color:var(--pg-fg);padding:8px 10px;border-radius:4px;border:1px solid var(--pg-border);'
  return banner
}
