...
describe('[dcent-web-connector] Bridge - init', () => {
    ...
    it('syncAccount() - success HEDERA', async (done) => {
        const accountInfos = [
            {
                coin_group: DcentWebConnector.coinGroup.HEDERA,
                coin_name: DcentWebConnector.coinName.HEDERA,
                label: 'HEDERA-01',
    ...
    it('getAccountInfo() - success, HEDERA Check ', async (done) => {
        const accountInfos = [
            {
                coin_group: DcentWebConnector.coinGroup.HEDERA,
                coin_name: DcentWebConnector.coinName.HEDERA,
